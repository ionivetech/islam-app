  ...
  >
    <div class="container flex items-center justify-between">
      ...
      <div class="flex items-center gap-x-4">
        ...
        <!-- Play button -->
        <div
          class="flex cursor-pointer items-center text-xs text-teal-700 md:text-sm dark:text-teal-500"
          @click="playSurah"
        >
          <Icon
            name="heroicons:play-solid"
            class="mr-1 text-base text-teal-700 md:text-lg dark:text-teal-500"
          />
          Putar
        </div>
      </div>
